...
<div class="min-h-screen bg-base-100">
  <div class="navbar bg-base-200 border-b border-base-300">
    <div class="flex-1">
      <a href="#/" class="btn btn-ghost text-xl font-mono">tix</a>
    </div>
    <div class="flex-none">
      <label class="swap swap-rotate btn btn-ghost btn-circle">
        <input type="checkbox" class="theme-controller" value="dark" onchange={(e) => document.documentElement.setAttribute('data-theme', (e.target as HTMLInputElement).checked ? 'dark' : 'light')} />
